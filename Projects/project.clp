...
; RULE TO BUY XIAOMI LAPTOP ABOVE 15K
(defrule lap_xiaomi_above15k
	(and ?ins <- (object (is-a DEVICENAME) (price above15k)(company xiaomi))
	(object (is-a PERSON) (devicetype laptop)))
	=> 
	(send ?ins put-suggested_device "Xiaomi Mi Max Prime (Rs. 19999/-)"))
	
; RULE TO BUY LENOVO LAPTOP ABOVE 15K
(defrule lap_lenovo_above15k
	(and ?ins <- (object (is-a DEVICENAME) (price above15k)(company lenovo))
	(object (is-a PERSON) (devicetype laptop)))
	=> 
	(send ?ins put-suggested_device "Lenovo laptop 2 Plus (Rs. 15999/-)"))
	
; RULE TO BUY HUAWEI LAPTOP ABOVE 15K
(defrule lap_huawei_above15k
	(and ?ins <- (object (is-a DEVICENAME) (price above15k)(company huawei))
	(object (is-a PERSON) (devicetype laptop)))
	=> 
	(send ?ins put-suggested_device "Huawei Mate 8 (Rs. 49999/-)"))
	
; RULE TO BUY LAPTOP UNDER 15K
(defrule lap_under15k_micromax
	...
	(printout t crlf)
	(printout t "Let me select a Laptop Under 15K..." crlf)) 
